...
def get_mlst_files(url: str, directory: str, client_key: str, client_secret: str, 
    ...
    try:
        ...
        if response.status_code == 401:
            ...
            config = configparser.ConfigParser(interpolation=None)
            access_tokens_file = Path.home() / ".config" / "mlstdb" / "access_tokens"
            ...
            if r.status_code == 200:
                ...
                config = configparser.ConfigParser(interpolation=None)
                session_tokens_file = Path.home() / ".config" / "mlstdb" / "session_tokens"
        ...
        if e.response.status_code in [401, 403]:
            ...
            info("1. Run 'mlstdb fetch' to refresh your credentials")
            info("2. Try running this command again")
            sys.exit(1)
